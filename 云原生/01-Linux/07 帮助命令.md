...
# 550. <font style="color:#DF2A3F;">1 帮助命令</font>
## 1.1 man命令获取帮助信息
基本语法
...
GNU coreutils 8.22                                                                       December 2015                                                                                   LS(1)
```
...
以上是help用与内置shell命令的用法。

除此之外，外部命令也可以用于help命令，不过是这样用

...
4. 测试例子 
   ...
   1. [http://localhost:8080/actuator/beans](http://localhost:8080/actuator/beans)
   2. [http://localhost:8080/actuator/configprops](http://localhost:8080/actuator/configprops)
   3. [http://localhost:8080/actuator/metrics](http://localhost:8080/actuator/metrics)
   4. [http://localhost:8080/actuator/metrics/jvm.gc.pause](http://localhost:8080/actuator/metrics/jvm.gc.pause)
   5. [http://localhost:8080/actuator/metrics/endpointName/detailPath](http://localhost:8080/actuator/metrics/endpointName/detailPath)

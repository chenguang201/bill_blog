...
策略模式的相关文章：[用设计模式来替代if-else - didi516 - 博客园](https://www.cnblogs.com/DiDi516/p/11787257.html)
...
【例】促销活动：一家百货公司在定年度的促销活动。针对不同的节日（春节、中秋节、圣诞节）推出不同的促销活动，由促销员将促销活动展示给客户。类图如下：

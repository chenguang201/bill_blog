...
Builder是为创建一个Product对象的各个部件指定的接口
end note
...
note bottom of ConcreateBuilder
具体的构建者，实现Builder接口，构造和装配各个部件
end note
...
Director o-- Builder:集合
Builder <|.. ConcreateBuilder:实现
Product <.. ConcreateBuilder:依赖

@enduml
```

## 3 实例
**创建共享单车：**生产自行车是一个复杂的过程，它包含了车架，车座等组件的生产。而车架又有碳纤维，铝合金等材质的，车座有橡胶，真皮等材质。对于自行车的生产就可以使用建造者模式。

这里Bike是产品，包含车架，车座等组件；Builder是抽象建造者，MobikeBuilder和OfoBuilder是具体的建造者；Director是指挥者。类图如下：

![](https://cdn.nlark.com/yuque/__puml/0b0bf347cdded45911d9b10313f6486d.svg)
...
## 7 创建者模式对比
**<font style="color:#E8323C;">工厂方法模式VS建造者模式</font>**
...
** ****<font style="color:#E8323C;">抽象工厂模式VS建造者模式</font>**

...
+  1 处，创建 NioEventLoopGroup，可以简单理解为 `<font style="color:#E8323C;">线程池 + Selector</font>` 后面会详细展开 
...
+ 如果写入后数据大小超过 512，则选择下一个 2^n，例如写入后大小为 513，则扩容后 capacity 是 2<sup>10=1024（2</sup>9=512 已经不够了）

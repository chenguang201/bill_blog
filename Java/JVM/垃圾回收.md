...
`<font style="color:rgb(51,51,51);">-XX:+UseSerialGC = Serial + SerialOld</font>`
...
`<font style="color:rgb(51,51,51);">-XX:MaxGCPauseMillis=ms </font>`
...
其中findstr是window下的过滤指令，mac和linux可以用grep

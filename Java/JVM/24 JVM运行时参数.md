...
# 1. JVM 参数选项
官网地址：[https://docs.oracle.com/javase/8/docs/technotes/tools/windows/java.html](f73800f1528b262a322056f33c59cabc)
...
官网地址：[https://docs.oracle.com/javase/8/docs/technotes/guides/vm/server-class.html](2b8122444b8c129a7fb7c19a9d4bb7b1)
...
```shell
# 22. linux下catalina.sh添加
JAVA_OPTS="-Xms512M -Xmx1024M"
# 23. windows下catalina.bat添加
...
3 + (5 * CPUï¼¿Count / 8) & \text (CPU\_Count > 8)
\end{cases}
 $

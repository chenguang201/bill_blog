...
```plain
# 10. range start-end ,data node index 
# 11. K=1000,M=10000. 
0-500M=0 
500M-1000M=1 
1000M-1500M=2
...
<tableRule name="sharding-by-substring">
  <rule>
    <columns>id</columns>
    sharding-by-substring</algorithm>
  </rule>
</tableRule>
...
<tableRule name="sharding-by-long-hash">
  <rule>
    <columns>id</columns>
    sharding-by-long-hash</algorithm>
  </rule>
</tableRule>
...
<tableRule name="sharding-by-stringhash">
  <rule>
    ...
    sharding-by-stringhash</algorithm>
  </rule>
</tableRule> 
